 ...
 * @author Fabio BaÌa
 * @since 12/01/2012
 * controller do questionario - respons·vel por tratar as requisiÁıes via get, post ou session.
 * Controla o fluxo da aplicaÁ„o definindo qual p·gina chamar de acordo com a action recebida.
 **/
...
// 	$questionarioDAO;
	 ...
	 * @author Fabio BaÌa
	 * @since 12/01/2012
	 * funÁ„o que verifica a action e direciona para a action especÌfica
	 **/
...
// 				echo "questao ".$qn[question_id];
			...
			$_SESSION["s_message"] = "AvaliaÁ„o realizada com sucesso!";
			$page = "avaliacoes.php";
			redirectTo($page);
	...
	* funÁ„o nao utilizada ate agora
	**/
...
echo $aluno->getRa();
	 ...
	 * @author Fabio BaÌa
	 * @since 12/01/2012
	 * funÁ„o que lanÁa dados na sess„o
	 **/
	 ...
	 * @author Fabio BaÌa
	 * @since 12/01/2012
	 * funÁ„o que redireciona pra uma pagina especÌfica
	 **/
