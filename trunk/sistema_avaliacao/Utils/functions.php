...
* @author Fabio Baía
* @since 17/08/2012 15:06:25
* insert a description here
**/
function passwordGenerator($size = 6, $useSmall = false, $useCaps = true, $useNumbers = true, $useSimbols = false){
	...
	if ($useSmall) $caracteres .= $smallChars;
	if ($useCaps) $caracteres .= $capsChars;
	if ($useNumbers) $caracteres .= $numbers;
	if ($useSimbols) $caracteres .= $simbols;
