...
<?php if(($new == true) || $edit == true){	?>
    <div id="box">
		...
		?>
        	...
        	<label for="descricao">DescriÁ„o</label><br />
...
<?php } ?>
    ...
    <br />
        ...
        <a href="../Controller/processoController.php?action=new"  title="Novo Processo de AvaliaÁ„o" class="botao_right botaoGoogleBlue">Novo Processo</a>
