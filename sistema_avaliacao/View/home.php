...
<div id="wrapper" class="container">
    ...
    <div id="content">
        ...
        <div id="escala_conceitos">
            ...
            <div id="item_escala">
                ...
                <div class="star_escala">
                	<ul>
                    	<li class="star-marked" title="Questão não atendida">1</li>
                        <li class="star-unmarked" title="Questão atendida em até 25% das vezes">2</li>
                        <li class="star-unmarked" title="Questão atendida em até 50% das vezes">3</li>
                        <li class="star-unmarked" title="Questão atendida em até 75% das vezes">4</li>
                        <li class="star-unmarked" title="Questão atendida em até 100% das vezes">5</li>
                    </ul>
                </div>
            </div>
            <div id="item_escala">
                ...
                <div class="star_escala">
                	<ul>
                    	<li class="star-marked" title="Questão não atendida">1</li>
                        <li class="star-marked" title="Questão atendida em até 25% das vezes">2</li>
                        <li class="star-unmarked" title="Questão atendida em até 50% das vezes">3</li>
                        <li class="star-unmarked" title="Questão atendida em até 75% das vezes">4</li>
                        <li class="star-unmarked" title="Questão atendida em até 100% das vezes">5</li>
                    </ul>
            ...
            <div id="item_escala">
                ...
                <div class="star_escala">
                	<ul>
                    	<li class="star-marked" title="Questão não atendida">1</li>
                        <li class="star-marked" title="Questão atendida em até 25% das vezes">2</li>
                        <li class="star-marked" title="Questão atendida em até 50% das vezes">3</li>
                        <li class="star-unmarked" title="Questão atendida em até 75% das vezes">4</li>
                        <li class="star-unmarked" title="Questão atendida em até 100% das vezes">5</li>
                    </ul>
                </div>
            ...
            <div id="item_escala">
                ...
                <div class="star_escala">
                	<ul>
                        ...
                        <li class="star-marked" title="Questão atendida em até 25% das vezes">2</li>
                        <li class="star-marked" title="Questão atendida em até 50% das vezes">3</li>
                        <li class="star-marked" title="Questão atendida em até 75% das vezes">4</li>
                        <li class="star-unmarked" title="Questão atendida em até 100% das vezes">5</li>
                    </ul>
                </div>
            </div>
            <div id="item_escala">
                ...
                <div class="star_escala">
                	<ul>
                        ...
                        <li class="star-marked" title="Questão atendida em até 50% das vezes">3</li>
                        <li class="star-marked" title="Questão atendida em até 75% das vezes">4</li>
                        <li class="star-marked" title="Questão atendida em até 100% das vezes">5</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <span class="btn-comecar-avaliacao"><a href="avaliacoes.php">Começar Avaliação</a></span>
    </div>
    <div id="footer">
        <hr />
